...
{{--            <label for="isgroup">Group</label>--}}
            ...
            <input type="text" name="group_name" id="group_name" class="rounded bg-dark text-white" placeholder="E.g. The cooler kids club" required>

            <br>

            <label for="users" class="mt-5">Select people to add</label> <br>
            <select multiple name="users[]" id="users" class="custom-select col-8 mt-3 bg-dark border border-secondary rounded shadow-lg text-white text-center" required>
