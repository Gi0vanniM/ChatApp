...
<script>
        <?php
            ...
            $chat_id = 0; // de id van de chat (waar deze user aanvast zit)
        ?>
...
<a href="/create" style="height: 30%" class="mx-auto"><button class="btn btn-success text-white mb-1"> Make a group chat</button></a>

<form id="chat_form" action="javascript:void(0);" onsubmit="SELF.send(document.getElementById('msg_box').value); " class=" ml-auto w-75">
<div class="form-group shadow-lg">
  <input type="text" name="msg" id="msg_box" class="form-control bg-dark text-white border border-secondary rounded" placeholder="Send a message" aria-describedby="helpId">
</div>
